...
drag(mainframe2)
mainframe2.Text = "Made By 2AreYouMental110"
...
mainframe2.Parent = gui2local localplr = game.Players.LocalPlayer
local drag = nil
pcall(function()
    drag = loadstring(game:HttpGet("https://rawscripts.net/raw/Universal-Script-Drag-UI-SUPPORTS-MOBILE-22790"))()
end)
...
mainframe2.Parent = gui2loadstring(game:HttpGet("https://pastebin.com/raw/0i3Qe4vL"))()
